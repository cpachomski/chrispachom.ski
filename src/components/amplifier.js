...
const Container = styled.div`
  ...
  > *:first-child {
    animation: ${props =>
      props.animate ? `${amplifierAnimation} .1s linear infinite` : ''};
  }
  ...
  > *:nth-child(2) {
    ...
    animation: ${props =>
      props.animate ? `${speakerAnimation} .4s linear infinite` : ''};
  }

  #statusLight {
    fill: ${props => (props.animate ? 'red' : '')};
  }
`

const AmplifierSvg = styled.svg`
  z-index: 1;
